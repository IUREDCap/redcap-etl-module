...
class Help
{
    ...
    private static $help = [
        ...
        'auto-generate-rules' =>
            ...
            ."</p>"
            ."<p>"
            ."<b>For non-longitudinal studies only, if you want to combine all non-repeating fields from different"
            ." forms into one table</b>, you can enter the name you want for that table."
            ." If you enter a table name here, and your project is longitudinal,"
