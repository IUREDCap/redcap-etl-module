...
<p>
You will be able to run a REDCap-ETL configuration on the ETL servers to which you have been granted access. A REDCap-ETL adminstrator sets the access-level permissions for the ETL servers. Once you have permissions to a server, there are 2 basic ways to run REDCap-ETL:
</p>
<div style="max-width: 800px;">
<ol>
    ...
    tab. The servers for which you have permissions will be displayed in a drop-down box. Select an ETL server, as well as an ETL configuration, and click the <strong>Run</strong>
    button.
    </li>
    ...
    day of the week for the job to run.The servers for which you have permissions will be displayed in a drop-down box. Select a server, specify the day(s) and time(s), and click the <strong>Save</strong> button.
    </li>
</ol>
</div>
