...
try {
    ...
    $etlListUrl  = $module->getUrl("web/index.php");
...
<form action="<?php echo $selfUrl;?>" method="post" 
    ...
    <div style="padding:10px;">
        <span style="font-weight: bold;">What do to you want to configure:</span>
    </div>

    <div>
        <input type="radio" name="configureType" value="etl" id="etl"
            onclick="document.location.href='<?php echo $etlListUrl; ?>'">
        <label for="etl">ETL Configurations</label>
    </div>

    <div>
        <input type="radio" name="configureType" value="workflow" id="workflow"
            onclick="document.location.href='<?php echo $workflowListUrl; ?>'">
        <label for="etl">Workflow Configurations</label>
    </div>
