...
try {
    ...
    $taskScheduleUrl  = $module->getUrl("web/task_schedule.php");
    $workflowScheduleUrl  = $module->getUrl("web/workflow_schedule.php");
...
<form action="<?php echo $selfUrl;?>" method="post" 
    ...
    <div>
        <input type="radio" name="configureType" value="etl" id="etl"
            onclick="document.location.href='<?php echo $taskScheduleUrl; ?>'">
        <label for="etl">An ETL configuration</label>
    </div>

    <div>
        <input type="radio" name="configureType" value="workflow" id="workflow"
            onclick="document.location.href='<?php echo $workflowScheduleUrl; ?>'">
